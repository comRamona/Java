public class Cost {
	...
	private static final String ps = "pounds sterling", us = "US dollars",
			eu = "euros";
	...
	public void setCurrency(String s) {
		if (s.equals(ps) || s.equals(us) || s.equals(eu))
			currency = s;
	}
	...
	public void convert(String newCurrency, double rate) {
		if (newCurrency.equals(ps) || newCurrency.equals(us)
				|| newCurrency.equals(eu)) {
